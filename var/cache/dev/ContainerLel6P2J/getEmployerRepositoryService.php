...
// Returns the private 'App\Repository\EmployerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EmployerRepository.php';

return $this->privates['App\\Repository\\EmployerRepository'] = new \App\Repository\EmployerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
