 ...
 */
final class Version20190712181355 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE employer (id INT AUTO_INCREMENT NOT NULL, idservice_id INT NOT NULL, matricule VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, date_naiss DATE NOT NULL, salaire INT NOT NULL, INDEX IDX_DE4CF06620F5B4DC (idservice_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
